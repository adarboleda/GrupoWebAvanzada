...
function ProductList() {
    ...
    // 2. usar usseffect para cargar los productos desde una API o fuente de datos
    useEffect(() => {
        // Simular carga de datos
        const loadProducts = async () => {
            //llamar a la api dummyjson
                            ...
                            <div key={i} className="col-12 md:col-6 lg:col-4">
                                <div className="p-2">
                                    <div className="shadow-2 p-4 surface-card border-round">
                                        ...
                                        {/*Descripcion */}
                                        <p className="mt-0 mb-3 text-700 line-height-3">{product.description ?? 'No hay descripción...'}</p>
                                        {/*Precio */}
